...
class Die extends SpriteGroupComponent<DieState> with HasGameRef<RollDiceGame>, Tappable {
  Die()
      : super(
          size: Vector2.all(80),
  ...
  Future<void> _loadSprites() async {
    ...
    final spriteSheet =
        SpriteSheet.fromColumnsAndRows(image: await Flame.images.load('game/dice-roll.png'), columns: 4, rows: 8);
