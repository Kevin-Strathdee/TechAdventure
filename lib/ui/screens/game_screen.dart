...
class _GameScreenState extends State<GameScreen> {
  ...
  Path drawCoffeeBean(Size size) {
    ...
    path.cubicTo(size.width * 0.84, size.height * 0.07, size.width * 0.7,
        size.height * 0.27, size.width * 0.49, size.height * 0.49);
    path.cubicTo(size.width * 0.27, size.height * 0.71, size.width * 0.06,
        size.height * 0.84, size.width * 0.02, size.height * 0.79);
    path.cubicTo(-0.03, size.height * 0.75, 0, size.height * 0.43,
        size.width * 0.22, size.height * 0.22);
    path.cubicTo(size.width * 0.43, size.height * 0.01, size.width * 0.75,
        -0.03, size.width * 0.79, size.height * 0.02);
    path.cubicTo(size.width * 0.79, size.height * 0.02, size.width * 0.79,
        size.height * 0.02, size.width * 0.79, size.height * 0.02);
    path.lineTo(size.width / 5, size.height * 0.98);
    path.cubicTo(size.width * 0.16, size.height * 0.94, size.width * 0.3,
        size.height * 0.73, size.width * 0.51, size.height * 0.51);
    path.cubicTo(size.width * 0.73, size.height * 0.3, size.width * 0.94,
        size.height * 0.16, size.width * 0.98, size.height / 5);
    path.cubicTo(size.width * 1.03, size.height / 4, size.width,
        size.height * 0.57, size.width * 0.78, size.height * 0.78);
    path.cubicTo(size.width * 0.57, size.height, size.width / 4,
        size.height * 1.03, size.width / 5, size.height * 0.98);
    path.cubicTo(size.width / 5, size.height * 0.98, size.width / 5,
        size.height * 0.98, size.width / 5, size.height * 0.98);
    path.lineTo(size.width / 5, size.height * 0.98);
    return path;
  }
                ...
                child: Card(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        state.points > 0
                            ? "You beat the high score and won ${state.points} jamBeans!"
                            : "You weren't able to crack the high score of ${state.place.minigame.score}.",
